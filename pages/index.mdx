...
Unlike Moloch V2, transferability of these tokens can be controlled by the DAO. For example, a DAO may start soul bound (like v2) but then decide at some future time to turn on tradability for shares and/or loot.
