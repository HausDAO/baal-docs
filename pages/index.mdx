...
_There was a time when humanity assumed we were at battle against each other. However, we were actually in a battle with Moloch -- the demon God of coordination failure. A strategy to beat Moloch was hypothesised, and Moloch v1 was an experiment to validate it._

_Moloch v2 expanded on its success, and gave us the confidence to be bolder with our solution. This birthed Baal, the third version of the MolochDAO contract aiming to strike fear in the eyes of Moloch itself._
...
There are two main governance units in Moloch v3. These are the same as that of [v2](https://github.com/MolochVentures/moloch), namely, *membership shares* and *loot shares*. However, the key difference is in their transferability.
...
<Callout emoji="👺">See the Governance config section for more info.</Callout>
